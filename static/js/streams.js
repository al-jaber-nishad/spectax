...
let handleUserJoined = async (user, mediaType) => {
  ...
  console.log("Joined............... in the top!!!!!!!!!!!!!!!!1");
...
let toggleCamera = async (e) => {
  ...
  if (localTracks[1].muted) {
    ...
    await localTracks[1].MuteLocalVideoStream(true);
    await localTracks[1].start();
...
document.addEventListener("click", leaveAndRemoveLocalStream);
